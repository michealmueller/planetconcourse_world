...
export class EmbedVideo {
  ...
  public async parseUrl(url, pasted = null) {
    ...
    html = url.replace(/^((http(s)?:\/\/)?(www\.)?(youtube\.com|youtu\.be)\/(watch\?v=|v\/)?)([a-zA-Z0-9\-_]+)(.*)?$/, '<div class="video video-youtube"><iframe width="892" height="520" src="//www.youtube.com/embed/$7" frameborder="0" allowfullscreen></iframe></div>')
      ...
      .replace(/^https?:\/\/www\.minds\.com\/media\/([0-9]+)\/?$/, `<span class="minds"><iframe src="https://www.planetconcourse.world/api/v1/embed/$1" width="720" height="320" frameborder="0" scrolling="no" allowtransparency="true"></video></iframe></span>`)
      .replace(/^https?:\/\/www\.minds\.com\/api\/v1\/embed\/([0-9]+)\/?$/, `<span class="minds"><iframe src="https://www.planetconcourse.world/api/v1/embed/$1" width="720" height="320" frameborder="0" scrolling="no" allowtransparency="true"></video></iframe></span>`);
